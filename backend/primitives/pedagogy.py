...
def equation_morph(scene: Scene, text_from: str, text_to: str, run_time: float = 1.5) -> None:
    ...
    from manim import ReplacementTransform, Text
...
def counter_animate(
    ...
    from manim import RIGHT, DecimalNumber, Text, ValueTracker, VGroup
...
def theorem_reveal(scene: Scene, statement: str, proof_steps: Sequence[Mobject]) -> None:
    ...
    from manim import DOWN, LEFT, UP, FadeIn, Text, Write
