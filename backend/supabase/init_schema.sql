...
-- Location: supabase/init_schema.sql
-- ==========================================
...
CREATE TABLE public.ai_steps (
  ...
  kind TEXT NOT NULL CHECK (kind IN ('director', 'planner', 'scene_designer', 'idea_sketcher', 'storyboarder', 'builder', 'code_reviewer', 'visual_reviewer')),
