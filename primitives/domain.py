...
from manim import VGroup, WHITE, BLUE, RIGHT, LEFT, UP, DOWN
...
def get_graph_network(
    ...
    return Graph(vertices, edges, layout=layout, vertex_config={"fill_color": vertex_color}, edge_config={"stroke_color": edge_color})
...
def get_binary_tree(
    ...
    from manim import Circle, Line, Text, WHITE, BLUE
...
def get_timeline(
    ...
    from manim import NumberLine, Dot, Text, UP, DOWN
...
def get_flowchart(
    ...
    from manim import RoundedRectangle, Arrow, Text, DOWN
