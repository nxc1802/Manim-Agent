...
def test_log_parser_attribute_error() -> None:
    logs = """
...
def test_log_parser_name_error() -> None:
    logs = """
...
def test_api_registry_deprecated() -> None:
...
def test_api_registry_exact() -> None:
    registry = ManimAPIRegistry()
...
def test_reviewer_context_building() -> None:
